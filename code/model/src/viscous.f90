...
!      KxPassTr= 1.d-1                                                  
  ...
  do k=1,NK 
    do j=1,NJ 
      ...
      do i=1,NI 
        udif(i,j,k)= udif(i,j,k)+ Kx*ux(i,j)*(dudxfc(i)-dudxfc(i-1))                
        vdif(i,j,k)= vdif(i,j,k)+ Kx*ux(i,j)*(dvdxfc(i)-dvdxfc(i-1))                
        wdif(i,j,k)= wdif(i,j,k)+ Kx*ux(i,j)*(dwdxfc(i)-dwdxfc(i-1))                
        sdif(i,j,k)= sdif(i,j,k)+ Kx*ux(i,j)*(dsdxfc(i)-dsdxfc(i-1))                
        Tdif(i,j,k)= Tdif(i,j,k)+ Kx*ux(i,j)*(dTdxfc(i)-dTdxfc(i-1))                
        do it=1,ntr 
